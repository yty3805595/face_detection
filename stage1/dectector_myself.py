...
def train(args, train_loader, valid_loader, model, criterion, optimizer, device):
    ...
    for epoch_id in range(epoch):
        ...
        for batch_idx, batch in enumerate(train_loader):
			...
			# get loss
            loss = pts_criterion(output_pts, target_pts)/(112*112)
        ...
        train_loss /= len(train_loader) * 1.0
        ######################
        # validate the model #
        ######################
        ...
        with torch.no_grad():
            ...
            for valid_batch_idx, batch in enumerate(valid_loader):
                ...
                valid_loss = pts_criterion(output_pts, target_pts)/(112*112)
				
                valid_mean_pts_loss += valid_loss.item()*input_img.size(0)
    ...
    return train_loss, valid_mean_pts_loss
